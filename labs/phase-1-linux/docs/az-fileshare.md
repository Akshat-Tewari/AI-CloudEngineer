...
Implemented a "Check-Before-Create" logic using az storage account list and az storage share exists. This prevents the script from failing on subsequent runs and ensures the environment remains stable.
